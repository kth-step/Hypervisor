...
extern BOOL buddy_init(buddy_ctxt_t * buddy, uint32_t base, uint32_t size,
...
extern BOOL buddy_alloc_at(buddy_ctxt_t * buddy, uint32_t adr, int order,
			   uint32_t * ret);

extern int buddy_get_order_from_size(buddy_ctxt_t * buddy, addr_t size);

extern BOOL buddy_contains_order(buddy_ctxt_t * buddy, int order,
				 BOOL or_larger);
