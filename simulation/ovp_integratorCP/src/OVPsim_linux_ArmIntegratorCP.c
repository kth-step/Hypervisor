...
static const char *arguments =
    "[variant <ARM cpu model variant>] [wallclock]\n"
...
void createPlatform(int debug, int verbose, icmProcessorP * cpu_,
		    icmBusP * bus_)
{
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *cm_path = icmGetVlnvString(0,	// path (0 if from the product directory)
					       0,	// vendor
					       0,	// library
					       "CoreModule9x6",	// name
					       0,	// version
	...
	icmPseP cm_p = icmNewPSE("cm",	// name
				 cm_path,	// model
				 cm_attr,	// attrlist
				 0,	// semihost file
				 0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *pic1_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						 0,	// vendor
						 0,	// library
						 "IntICP",	// name
						 0,	// version
	...
	icmPseP pic1_p = icmNewPSE("pic1",	// name
				   pic1_path,	// model
				   pic1_attr,	// attrlist
				   0,	// semihost file
				   0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *pic2_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						 0,	// vendor
						 0,	// library
						 "IntICP",	// name
						 0,	// version
	...
	icmPseP pic2_p = icmNewPSE("pic2",	// name
				   pic2_path,	// model
				   pic2_attr,	// attrlist
				   0,	// semihost file
				   0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *ethlan_path = icmGetVlnvString(0,	// path (0 if from the product directory)
	...
	icmPseP ethlan_p = icmNewPSE("ethlan",	// name
				     ethlan_path,	// model
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *pit_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
	...
	icmPseP pit_p = icmNewPSE("pit",	// name
				  pit_path,	// model
				  pit_attr,	// attrlist
				  0,	// semihost file
				  0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *icp_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
						"IcpControl",	// name
						0,	// version
	...
	icmPseP icp_p = icmNewPSE("icp",	// name
				  icp_path,	// model
				  icp_attr,	// attrlist
				  0,	// semihost file
				  0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *ld1_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
	...
	icmPseP ld1_p = icmNewPSE("ld1",	// name
				  ld1_path,	// model
				  ld1_attr,	// attrlist
				  0,	// semihost file
				  0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *kb1_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
						"KbPL050",	// name
						0,	// version
	...
	const char *kb1_pe = icmGetVlnvString(0,	// path (0 if from the product directory)
					      0,	// vendor
					      0,	// library
					      "KbPL050",	// name
					      0,	// version
	...
	icmPseP kb1_p = icmNewPSE("kb1",	// name
				  kb1_path,	// model
				  kb1_attr,	// attrlist
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *ms1_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
						"KbPL050",	// name
						0,	// version
	...
	const char *ms1_pe = icmGetVlnvString(0,	// path (0 if from the product directory)
					      0,	// vendor
					      0,	// library
					      "KbPL050",	// name
					      0,	// version
	...
	icmPseP ms1_p = icmNewPSE("ms1",	// name
				  ms1_path,	// model
				  ms1_attr,	// attrlist
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *rtc_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
						"RtcPL031",	// name
						0,	// version
	...
	icmPseP rtc_p = icmNewPSE("rtc",	// name
				  rtc_path,	// model
				  rtc_attr,	// attrlist
				  0,	// semihost file
				  0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *uart1_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						  0,	// vendor
						  0,	// library
						  "UartPL011",	// name
						  0,	// version
	...
	icmPseP uart1_p = icmNewPSE("uart1",	// name
				    uart1_path,	// model
				    uart1_attr,	// attrlist
				    0,	// semihost file
				    0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *uart2_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						  0,	// vendor
						  0,	// library
						  "UartPL011",	// name
						  0,	// version
	...
	icmPseP uart2_p = icmNewPSE("uart2",	// name
				    uart2_path,	// model
				    uart2_attr,	// attrlist
				    0,	// semihost file
				    0	// semihost symbol
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *mmci_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						 0,	// vendor
						 0,	// library
						 "MmciPL181",	// name
						 0,	// version
...
#define MMCUSESNATIVE
#ifdef MMCUSESNATIVE
	const char *mmci_pe = icmGetVlnvString(0,	// path (0 if from the product directory)
					       0,	// vendor
					       0,	// library
					       "MmciPL181",	// name
					       0,	// version
	...
	icmPseP mmci_p = icmNewPSE("mmci",	// name
				   mmci_path,	// model
				   mmci_attr,	// attrlist
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *lcd_path = icmGetVlnvString(0,	// path (0 if from the product directory)
						0,	// vendor
						0,	// library
						"LcdPL110",	// name
						0,	// version
	...
	const char *lcd_pe = icmGetVlnvString(0,	// path (0 if from the product directory)
					      0,	// vendor
					      0,	// library
					      "LcdPL110",	// name
					      0,	// version
	...
	icmPseP lcd_p = icmNewPSE("lcd",	// name
				  lcd_path,	// model
				  lcd_attr,	// attrlist
...
////////////////////////////////////////////////////////////////////////////////
	...
	const char *smartLoader_path = icmGetVlnvString(0,	// path (0 if from the product directory)
							"arm.ovpworld.org",	// vendor
							0,	// library
...
//    char *ramDisk = "fs.img";
	char *ramDisk =
	    "/home/viktordo/LinuxPort/LinuxSICS/linux-2.6.34.3/rootfs.cpio";
	//char *kernelFile = "/home/viktor/LinuxPort/linux-2.6.34.3/arch/arm/boot/zImage";
	char *kernelFile =
	    "/home/viktordo/LinuxPort/LinuxSICS/linux-2.6.34.3/arch/arm/boot/zImage";
...
//        icmAddStringAttr(smartLoader_attr, "command", "console=ttyS1,115200n8 console=tty0");
		...
		icmAddStringAttr(smartLoader_attr, "command",
				 "earlyprintk=serial, console=ttyAMA0");
	...
	icmPseP smartLoader_p = icmNewPSE("smartLoader",	// name
...
//    icmNewBusBridge(bus1_b, membus_b, "ram1Bridge", "sp", "mp", 0x0, 0x7ffffff, 0x0);
	icmNewBusBridge(bus1_b, membus_b, "ram1Bridge", "sp", "mp", 0x0,
			0xfffffff, 0x0);
...
//    icmNewBusBridge(bus1_b, membus_b, "ram2Bridge", "sp1", "mp", 0x0, 0x7ffffff, 0x80000000);
	icmNewBusBridge(bus1_b, membus_b, "ram2Bridge", "sp1", "mp", 0x0,
