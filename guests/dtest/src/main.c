...
enum dmmu_command {
	...
	CMD_CREATE_L2_PT, CMD_MAP_L1_PT, CMD_MAP_L2_ENTRY,
	CMD_UNMAP_L2_ENTRY, CMD_FREE_L2, CMD_CMD_CREATE_L1_PT
};
...
void dmmu_unmap_L1_pageTable_entry_()
{
 ...
 :				/* No clobbers */ );
	...
	if (res == 1)
		...
		printf
		    ("unmap_L1_pageTable_entry 1: SUCCESS, add %x, res %d\n",
		     va, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 1)
		...
		printf
		    ("unmap_L1_pageTable_entry 2: SUCCESS, add %x, res %d\n",
		     va, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 2)
		...
		printf
		    ("unmap_L1_pageTable_entry 3: SUCCESS, add %x, res %d\n",
		     va, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 0)
		...
		printf
		    ("unmap_L1_pageTable_entry 4: SUCCESS, add %x, res %d\n",
		     va, res);
...
void dmmu_l2_map_entry_()
{
 ...
 :				/* No clobbers */ );
	...
	if (res != 0)
		...
		printf
		    ("l2_pt_map 0: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 0)
		...
		printf
		    ("l2_pt_map 1: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
 ...
 :				/* No clobbers */ );
	...
	if (res != 16)
		...
		printf
		    ("l2_pt_map 3: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
 ...
 :				/* No clobbers */ );
	...
	if (res != 12)
		...
		printf
		    ("l2_pt_map 4: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
 ...
 :				/* No clobbers */ );
	...
	if (res != 6)
		...
		printf
		    ("l2_pt_map 5: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 0)
		...
		printf
		    ("l2_pt_map 6: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 0)
		...
		printf
		    ("l2_pt_map 7: SUCCESS, l2_base %x pg_add %x, res %d\n",
		     pa, pga, res);
...
void dmmu_l2_unmap_entry_()
{
 ...
 :				/* No clobbers */ );
	...
	if (res != 3)
		...
		printf
		    ("l2_pt_map 0: SUCCESS, l2_base %x pg_idx %x, res %d\n",
		     pa, idx, res);
 ...
 :				/* No clobbers */ );
	...
	if (res != 12)
		...
		printf
		    ("l2_pt_map 1: SUCCESS, l2_base %x pg_idx %x, res %d\n",
		     pa, idx, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 0)
		...
		printf
		    ("l2_pt_map 2: SUCCESS, l2_base %x pg_idx %x, res %d\n",
		     pa, idx, res);
 ...
 :				/* No clobbers */ );
	...
	if (res == 0)
		...
		printf
		    ("l2_pt_map 3: SUCCESS, l2_base %x pg_idx %x, res %d\n",
		     pa, idx, res);
...
*/
	...
	ISSUE_DMMU_HYPERCALL(CMD_CMD_CREATE_L1_PT, pa, 0, 0);
