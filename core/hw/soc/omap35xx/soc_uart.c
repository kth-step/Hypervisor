...
void soc_uart_set(uint32_t * base, int pad_rx, int pad_tx, int pad_cts,
		  int pad_rts)
{
...
void soc_uart_init()
{
	...
	/* configure UART1 and UART3 */
	soc_uart_set(IO_VA_ADDRESS(UART1_BASE), SMC_PAD_NUMBER_UART1_RX,
		     SMC_PAD_NUMBER_UART1_TX,
		     SMC_PAD_NUMBER_UART1_CTS, SMC_PAD_NUMBER_UART1_RTS);

	soc_uart_set(IO_VA_ADDRESS(UART3_BASE), SMC_PAD_NUMBER_UART3_RX,
		     SMC_PAD_NUMBER_UART3_TX,
		     SMC_PAD_NUMBER_UART3_CTS, SMC_PAD_NUMBER_UART3_RTS);
