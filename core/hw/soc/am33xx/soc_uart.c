		  ...
		  int pad_rts)
{
	...
	if (pad_tx > 0)
		gpio_set_pad_configuration(pad_tx, 0, FALSE, FALSE, FALSE);
	if (pad_cts > 0)
		gpio_set_pad_configuration(pad_cts, 0, TRUE, TRUE, FALSE);	// pull down
	if (pad_rts > 0)
		gpio_set_pad_configuration(pad_rts, 0, FALSE, FALSE, FALSE);
