...
memory_layout_entry memory_padr_layout[] = {
	...
	{
	 ADDR_TO_PAGE(0x48002000), ADDR_TO_PAGE(0x48003000),
	...
	{
	 ADDR_TO_PAGE(0x4806a000), ADDR_TO_PAGE(0x4806b000),
	 MLT_IO_RW_REG, MLF_READABLE | MLF_WRITEABLE}
	,			/* UART1 4K */
	{
	 ADDR_TO_PAGE(0x4806c000), ADDR_TO_PAGE(0x4806d000),
	 MLT_IO_RW_REG, MLF_READABLE | MLF_WRITEABLE}
	,			/* UART2 4K */
	{
	 ADDR_TO_PAGE(0x48200000), ADDR_TO_PAGE(0x48201000),
	...
	{
	 ADDR_TO_PAGE(0x49020000), ADDR_TO_PAGE(0x49021000),
	 MLT_IO_RW_REG, MLF_READABLE | MLF_WRITEABLE}
	,			/*UART 3 */
	{
