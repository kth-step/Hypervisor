...
memory_layout_entry memory_padr_layout[] = {	//Used for mapping memory regions, and not memory-mapped I/O.
	...
	{ADDR_TO_PAGE(0x80F00000), ADDR_TO_PAGE(0x81000000), MLT_TRUSTED_RAM, MLF_READABLE | MLF_WRITEABLE},			/* trusted ram */
	//{ADDR_TO_PAGE(0x81000000), ADDR_TO_PAGE(0x88000000), MLT_USER_RAM, MLF_READABLE | MLF_WRITEABLE | MLF_LAST}, /* user ram */
	{ADDR_TO_PAGE(0x81000000), ADDR_TO_PAGE(0x81000000 + 0x00800000), MLT_USER_RAM, MLF_READABLE | MLF_WRITEABLE | MLF_LAST},			// user ram
};
