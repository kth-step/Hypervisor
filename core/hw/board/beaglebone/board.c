...
//      pt_create_coarse(flpt_va, AM33XX_L4_WK_IO_OFFSET(0x44E0D000), 0x44E0D000, 0x2000, MLT_IO_RW_REG);       /* ADC_TSC */
	...
	pt_create_coarse(flpt_va, AM33XX_L4_WK_IO_OFFSET(0x44E10000), 0x44E10000, 0x2000, MLT_IO_RO_REG);	/* Control Module: Reads device ID. */
//      pt_create_coarse(flpt_va, AM33XX_L4_WK_IO_OFFSET(0x44E12000), 0x44E12000, 0x1000, MLT_IO_RW_REG);       /* DDR2/3/mDDR PHY */
	pt_create_coarse(flpt_va, AM33XX_L4_WK_IO_OFFSET(0x44E31000), 0x44E31000, 0x1000, MLT_IO_RW_REG);	/* DMTIMER1_1MS: Writes TIOCP_CFG to which controls various parameters of the OCP interface. */
	pt_create_coarse(flpt_va, AM33XX_L4_WK_IO_OFFSET(0x44E35000), 0x44E35000, 0x1000, MLT_IO_RW_REG);	/* WDT1: Writes Watchdog System Control Register which controls parameters of the L4 interface. */
