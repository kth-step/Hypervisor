...
void guests_init()
{
	...
	pt_create_section(flpt_va, 0x00000000,
			  0x01000000 + HAL_PHYS_START, MLT_TRUSTED_RAM);

	pt_create_section(flpt_va, 0x00100000, 0x01100000 + HAL_PHYS_START,
			  MLT_TRUSTED_RAM);

	pt_create_section(flpt_va, 0x00200000, 0x01200000 + HAL_PHYS_START,
			  MLT_TRUSTED_RAM);
